...
function Header() {
  ...
  return (
    <>
      <nav className="bg-gray-800 p-4 fixed top-0 w-full 'bg-primary shadow-md shadow-black' transition-all z-[9999]">
        <div className="md:container mx-auto w-full flex justify-between md:justify-between items-center ">
          <Link to="/">
            <img src={logo} className="h-12" alt="" height={20} width={30}/>
          </Link>
          ...
          <div className="hidden md:block text-lg">
            <ul >
              <div className="flex gap-8 lg-link font-medium text-white transition-all">
